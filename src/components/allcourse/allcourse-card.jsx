...
const CourseCard = ({ course = {}, lesson = {} }) => {
  ...
  const categoryName =
    categories.length > 0 ? categories[0].category_name : "No Category";
      ...
      <div className="p-4 relative overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center group">
            ...
            <Link to={`/វគ្គសិក្សា/${lessonId}/`} className="relative bg-primary text-white px-6 py-2 rounded-[40px] overflow-hidden group">
