...
const SignupComponent = () => {
  return (
    <>
      <h1 className="font-suwannaphum font-bold text-4xl  text-center w-auto mt-10">
        ស្វាគមន៍មកកាន់ការចុះឈ្មោះចូលរៀន <span className="text-primary ml-2 sm:w-[95%]2xl:w-[700px] max-w-[90%]">ISTEM</span>
      </h1>
