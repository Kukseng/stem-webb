...
import { useCreateLessonMutation } from "../../../api/lessons-api.js";
import { useCreateSectionMutation } from "../../../api/sections-api.js";
import { useCreateContentMutation } from "../../../api/content-api.js";
...
const CreateCourseForm = ({ accessToken }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setModalContent({
        type: "success",
        message: "បានបង្កើតវគ្គសិក្សាដោយជោគជ័យ!",
      });
      setIsModalOpen(true);
      resetForm();
    } catch (error) {
      ...
      setModalContent({
        type: "error",
        message:
          "បរាជ័យក្នុងការបង្កើតវគ្គសិក្សា: " +
