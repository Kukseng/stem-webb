            ...
            >
              <div className="pb-3">
                <div className="flex items-center bg-gray-50 border rounded-full border-gray-200">
                  ...
                  />
                  <button className="mr-2 bg-primary text-white px-4 py-1.5 rounded-full text-[15px] font-medium hover:bg-[#1e8fb8] transition-colors duration-200 transform hover:scale-105 active:scale-95">
                    ស្វែងរក
                  </button>
                </div>
              </div>
