  ...
  <div className="font-suwannaphum max-w-[1300px] mx-auto p-10 flex gap-10">
    ...
    <div className="w-3/4">
      ...
      <div className="mt-5">
        <img
          src={banner}
          alt="HTML Course 2025"
          className="w-full rounded-lg"
        />
      </div>

      <p className="mt-4 max-w-2xl text-lg leading-relaxed">
        បណ្តុំការរៀន HTML នេះផ្តល់នូវមេរៀនពេញលេញពីកម្រិតដំបូងដល់កម្រិតខ្ពស់។
      </p>

      <ul className="mt-4 list-disc pl-5 space-y-2">
        <li>
          HTML Basics – សិក្សាអំពីធាតុ (elements), structure, និងអត្ថបទ
          formatting។
        </li>
        ...
        <li>
          Responsive Design –
          បង្កើតគេហទំព័រដែលអាចប្រើបានល្អលើទូរស័ព្ទនិងកុំព្យូទ័រ។
        </li>
      </ul>
      ...
      <div className="flex gap-20">
        ...
        <div className="rounded-lg shadow-md p-5 flex items-center justify-between w-96 border">
          ...
          <div className="text-center">
            ...
            <h1 className="font-bold text-lg">
              វគ្គសិក្សារ HTML ល្អបំផុតសម្រាប់ឆ្នាំ
            </h1>
        ...
        <div className="rounded-lg shadow-md p-5 flex items-center justify-between w-96 border">
          <div className="text-center">
            <br />
            <h1 className="font-bold text-lg">
              វគ្គសិក្សារ HTML ល្អបំផុតសម្រាប់
            </h1>
      ...
      <div>
        <div className=" mx-auto p-4 border rounded-lg shadow-md bg-white">
          <div className="flex items-start space-x-4">
            <img src={lg} alt="Profile" className="w-12 h-12 rounded-full" />
            <div className="flex-1">
              ...
              <p className="mt-3 text-gray-700 mr-14 ml-3">
                សំណាងល្អសម្រាប់ផ្លូវការផងដែរ!
                ខ្ញុំរីករាយដែលប្រព័ន្ធសារបានអាចចងចាំដំណើរការចាស់ៗ HTML
                ពិតជាមានប្រយោជន៍មែន។
                យើងអាចស្វែងយល់បន្ថែមពីការប្រើប្រាស់បន្ថែមទៀត!
              </p>
    ...
    <div className="w-1/4">
      <div className=" bg-white p-5 rounded-lg shadow-md mb-5">
        ...
        <button className="mt-3 w-full bg-blue-500 text-white py-2 rounded-[40px]">
          តាមដាន
        </button>
      </div>
      ...
      <div className="bg-white p-5 ">
        ...
        <ul className="list-none space-y-2 mt-3">
          <div className="flex justify-between">
            <li>
              <a href="#">ការងារពេញនិយម</a>
            </li>
            <p>15</p>
          </div>
          <div className="flex justify-between">
            <li>
              <a href="#">មុខវិជ្ជាល្បីៗ</a>{" "}
            </li>
            <p>15</p>
          </div>
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            <li>
              <a href="#">ចំណេះដឺងទូទៅ</a>{" "}
            </li>
            <p>15</p>
          </div>
          <div className="flex justify-between">
            <li>
              <a href="#">Academy Camera</a>
            </li>
            <p>15</p>
          </div>
          <div className="flex justify-between">
            <li>
              <a href="#">Sigle Family Home</a>{" "}
            </li>
            <p>15</p>
          </div>
        </ul>
      ...
      <div className="bg-white p-5  mt-5">
        ...
        <div className="mt-3 space-y-3">
          <div className="flex gap-3​​ rounded-lg shadow-md">
            ...
            <p className="text-sm">
              រចនាប័ទ្មថ្មី Modern Theme Collection នៅឆ្នាំ 2023
            </p>
          </div>
          <br />
          <div className="flex gap-3 rounded-lg shadow-md">
            <img src={lg} alt="News" className="w-16 h-16 rounded-lg" />
            <p className="text-sm">
               រចនាប័ទ្មថ្មី Professional Theme Collection នៅឆ្នាំ 2023
            </p>
          </div>
          <br />
          <div className="flex gap-3 rounded-lg shadow-md">
