      ...
      <div className="">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="text-white font-suwannaphum items-center px-6 py-3 my-6 flex cursor-pointer bg-primary hover:bg-cyan-700 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm lg:text-sm text-center transition-all duration-300"
          >
